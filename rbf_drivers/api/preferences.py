...
class RBFDriverPreferences(AddonUpdatePreferences, AddonPreferences):
    ...
    #             subrow.operator("rbf_driver.addon_reset_update_status",
    #                             text="",
    #                             icon='X',
    #                             emboss=False)
    ...
    #             names.label(icon='BLANK1', text="Release Notes:")
    #             value.label(text=self.new_release_notes)
