...
from ..api.input_variables import INPUT_VARIABLE_TYPE_TABLE
...
def input_variable_data_init(data: 'InputData',
                             default_value: float,
                             pose_count: int,
                             normalize: bool) -> None:
    '''
...
def input_init__location(input: 'Input', pose_count: int) -> None:
    '''
    ...
    for axis in "XYZ":
        variable = input.variables.internal__.add()
...
def input_init__rotation(input: 'Input', pose_count: int) -> None:
    '''
...
def input_init__scale(input: 'Input', pose_count: int) -> None:
    '''
...
def input_init__rotation_diff(input: 'Input', pose_count: int) -> None:
    assert pose_count >= 1
...
def input_init__loc_diff(input: 'Input', pose_count: int) -> None:
    assert pose_count >= 1
...
def input_init__shape_key(input: 'Input', pose_count: int) -> None:
    '''
...
def input_init__user_def(input: 'Input', pose_count: int) -> None:
    '''
